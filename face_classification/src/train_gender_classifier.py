...
from utils.datasets import split_CAS_PEAL_data
...
patience = 100
num_classes = 2
dataset_name = 'CAS-PEAL-R1'
input_shape = (64, 64, 1)
if input_shape[2] == 1:
    grayscale = True
images_path = '../datasets/POSE/'
...
train_keys, val_keys = split_CAS_PEAL_data(ground_truth_data, validation_split)
